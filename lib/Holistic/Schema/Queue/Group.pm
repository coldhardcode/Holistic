package Holistic::Schema::Queue::Group;
...
$CLASS->set_primary_key(qw/queue_pk1 group_pk1/);

$CLASS->belongs_to('queue', 'Holistic::Schema::Queue', 'queue_pk1');
